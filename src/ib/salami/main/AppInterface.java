...
public class AppInterface {
	...
	protected void createContents() {
		shlSalamiDetector = new Shell(SWT.CLOSE | SWT.MIN | SWT.RESIZE | SWT.TITLE);
		shlSalamiDetector.setMinimumSize(new Point(680, 400));
		shlSalamiDetector.setSize(680, 768);
		...
		fd_tabFolder.bottom = new FormAttachment(0, 149);
